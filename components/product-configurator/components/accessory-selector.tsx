...
import { useAccessories } from '@/app/product/hooks/use-accessories';
                ...
                return (
                    ...
                    >
                        <div className="w-28 flex justify-center">
                            <Image className="w-28" src={option.imageUrl} alt={option.name} width={128} height={86} />
                        </div>
                        <div className="flex flex-col">
                            <div className="text-base text-gray-800">{option.name}</div>
                            <div className="text-sm text-gray-600">+ €{option.price.value}</div>
                        </div>
                    </div>
                );
            })}
