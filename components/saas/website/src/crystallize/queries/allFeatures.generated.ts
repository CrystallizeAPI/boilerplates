...
export type AllFeaturesQueryVariables = Types.Exact<{
  path: Types.Scalars['String'];
}>;


export type AllFeaturesQuery = (
  { __typename?: 'Query' }
  & { allFeaturesPage?: Types.Maybe<(
    { __typename?: 'Document' }
