  ...
  return (
    ...
    >
      ...
      <Flex css={{ gap: "20px", mx: "0 auto" }}>
        <Button onClick={() => setDate("2022-07-18T10:00:00.000Z")} size={{"@bp5": "sm"}}>
          Day 1
        </Button>
        <Button onClick={() => setDate("2022-07-19T10:00:00.000Z")} size={{"@bp5": "sm"}}>
          Day 2
        </Button>
        <Button onClick={() => setDate("2022-07-20T10:00:00.000Z")} size={{"@bp5": "sm"}}>
          Day 3
        </Button>
      </Flex>
      <Spacer space={10} />
