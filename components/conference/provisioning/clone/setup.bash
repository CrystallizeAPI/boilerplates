...
cp ${PROJECT_PATH}/provisioning/clone/.env.dist ${PROJECT_PATH}/website/.env.dist
...
cd ${PROJECT_PATH}/website && cat ${PROJECT_PATH}/website/.env.local.example ${PROJECT_PATH}/website/.env.dist > .env
cd ${PROJECT_PATH}/service-api && cat ${PROJECT_PATH}/service-api/.env.local.example ${PROJECT_PATH}/service-api/.env.dist > .env
